          ...
          >
            <g>
              <a  href="#con">
                ...
                <path
                @click="irParaPagEstado('Tocantins','TO')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
              ...
              <a  href="#con">
                <title>Bahia</title>
                <path
                   @click="irParaPagEstado('Bahia','BA')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a  href="#con">
                <title>Sergipe</title>
                <path
                  @click="irParaPagEstado('Sergipe','SE')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a  href="#con">
                ...
                <path
                  @click="irParaPagEstado('Pernambuco','PE')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a  href="#con">
                <title>Alagoas</title>
                <path
                 @click="irParaPagEstado('Alagoas','AL')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a href="#con">
                ...
                <path
                @click="irParaPagEstado('Rio Grande do Norte','RN')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a  href="#con">
                <title>Ceará</title>
                <path
                 @click="irParaPagEstado('Ceará','CE')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a href="#con">
                <title>Piauí</title>
                <path
                  @click="irParaPagEstado('Piauí','PI')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a href="#con">
                ...
                <path
                   @click="irParaPagEstado('Maranhão','MA')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a  href="#con">
                <title>Amapá</title>
                <path
                 @click="irParaPagEstado('Amapá','AP')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a href="#con">
                <title>Roraima</title>
                <path
                    @click="irParaPagEstado('Roraima','RR')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a  href="#con">
                ...
                <path
                 @click="irParaPagEstado('Amazonas','AM')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a  href="#con">
                ...
                <path
                  @click="irParaPagEstado('Rondônia','RO')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a  href="#con">
                ...
                <path
                   @click="irParaPagEstado('Mato Grosso','MT')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a  href="#con">
                ...
                <path
                 @click="irParaPagEstado('Mato Grosso do Sul','MS')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a  href="#con">
                <title>Goiás</title>
                <path
                   @click="irParaPagEstado('Goiás','GO')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a  href="#con">
                <title>Paraná</title>
                <path
                @click="irParaPagEstado('Paraná','PR')"
                 class="corVerde"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
              ...
              <a  href="#con">
                ...
                <path
                @click="irParaPagEstado('Santa Catarina','SC')" 
                  class="corVerde"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
              ...
              <a href="#con">
                ...
                <path              
                 @click="irParaPagEstado('Rio Grande do Sul','RS')" 
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a  href="#con">
                ...
                <path
                 @click="irParaPagEstado('São Paulo','SP')"            
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a  href="#con" >
                ...
                <path   
                 @click="irParaPagEstado('Minas Gerais','MG')" 
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a  href="#con" class="maisEscuro">
                <title>Rio de Janeiro</title>
                <path                 
                   @click="irParaPagEstado('Rio de Janeiro','RJ')"             
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a  href="#con">
                ...
                <path
                 @click="irParaPagEstado('Espírito Santo','ES')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a  href="#con">
                ...
                <path
                   @click="irParaPagEstado('Distrito Federal','DF')"
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a   href="#con">
                <title>Paraíba</title>
                <path      
                 @click="irParaPagEstado('Paraíba','PB')"         
                  stroke="#FFFFFF"
                  stroke-width="1.0404"
                  stroke-linecap="round"
                  stroke-linejoin="round"
...
export default {
    ...
    async created(){
        this.dados = await config.getLinkEstados()
    }
